...
void UnsubBytes(unsigned char* state)
{
    for (int i = 0; i < 16; i++)
    {
...
void UnshiftRows(unsigned char* state)
{
...
void UnmixCollums(unsigned char* state)
{
    unsigned char tmp[16];
...
void MixCollums(unsigned char* state) 
{
    unsigned char tmp[16];
...
int main()
{
    ...
    unsigned char message[] = "This is a message I will encrypt with AES!";
    ...
    int origenalLen = strlen((const char*)message);
    int lenOfPaddedMessage = origenalLen;
    ...
    unsigned char* paddedMessage = new unsigned char[16];
    ...
    cout << "Original Message: " << endl << message << endl;

    cout << "\nAES Encrypted Message:" << endl;
    for (int i = 0; i < lenOfPaddedMessage; i++)
     {
